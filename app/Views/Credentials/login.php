            ...
            <div class="row full-height justify-content-center">
                <div class="col-12 text-center align-self-center py-5">
                    <div class="section pb-5 pt-5 pt-sm-2 text-center">
                        <h6 class="mb-0 pb-3"><span>Log In </span><span>Sign Up</span></h6> <input class="checkbox" type="checkbox" id="reg-log" name="reg-log">
                                ...
                                <div class="card-front">
                                    <div class="center-wrap">
                                        <div class="section text-center">
                                            <!-- Login Form -->
                                            <form id="loginForm" action="<?= base_url('Credentials/credential_validation') ?>" method="post">
                                                <?= csrf_field() ?>
                                ...
                                <div class="card-back">
                                    <div class="center-wrap">
                                        <div class="section text-center">
                                            ...
                                            <!-- Signup Form -->
                                            <form id="signupForm" action="<?= base_url('Register') ?>" method="post">
                                                <?= csrf_field() ?>
