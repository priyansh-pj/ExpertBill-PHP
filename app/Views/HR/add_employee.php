            ...
            <table class="table table-hover">
                ...
                <tbody>
                    <?php foreach($Candidates as $candidate):?>
                        <form>
                        <?= csrf_field() ?>
                        <input type="hidden" name="candidate_username" value="<?=$candidate->username?>"></input>
                    <tr id="row<?=$candidate->uid?>">
                        ...
                        <td><center><a class="delete-candidate-btn btn btn-gradient-danger" style="padding:0.7rem;" data-uid="<?=$candidate->uid?>"><i class="mdi mdi-delete-forever"></i></a></center></td>
                        <td><center><button type="submit" class="btn btn-gradient-primary">View Profile</button></center></td>
                    </tr>
                    <form>
                    <?php endforeach;?>
                </tbody>
        ...
        <div class="card-body">
            ...
            <?= csrf_field() ?>
                <div class="form-group" style="display: flex; align-items: center;">
                    ...
                    <input class="form-control" type="text" name="candidate_username" placeholder="Candidate" style="flex: 1; margin-right: 10px;">
