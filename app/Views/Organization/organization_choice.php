            ...
            <div class="col-md-4 grid-margin stretch-card" style="margin-bottom: 1.3rem;">
                <div class="card">
                    <div class="card-body" style="padding: 1.7rem;">
                        <div class="clearfix">
                            <a href="<?= base_url('Organization/verify/' . $organization->id) ?>" style="text-decoration: none; color: inherit; display: inline-block; width: 100%;">
                                <h3 class="page-title">
...
<div class="row">
    <div class="col-md-4 grid-margin stretch-card" style="margin-bottom: 1.3rem;">
        <div class="card">
            <div class="card-body" style="padding: 1.7rem;">
                <div class="clearfix">
                    <a href="<?= base_url('Organization/make') ?>" style="text-decoration: none; color: inherit; display: inline-block; width: 100%;">
                        <h3 class="page-title">
                            <span class="page-title-icon bg-gradient-primary text-white me-2">
